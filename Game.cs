...
namespace DGD203_2
{
    public class Game
    {
        ...
        {
            Console.WriteLine("Welcome...why are you here?");
            Console.WriteLine("Anyway at least would you be kind enough to provide us with your name?");
            ...
            {
                Console.WriteLine($"Well now you are here {_playerName},let's get down to business shall we?");
            }
        }
        ...
        private void ProcessInput()
        {
            ...
            switch (_playerInput)
            {
                ...
                case "clear":
                    ...
                    break;
                case "who":
                    Console.WriteLine($"You are {Player.Name}, the mighty hero of the Isles i'd like to say but i still don't know why you are here");
                    break;
                case "take":
        ...
        {
            Console.WriteLine("Now get lost i better not see you around here again!");
            _gameRunning = false;
        }
